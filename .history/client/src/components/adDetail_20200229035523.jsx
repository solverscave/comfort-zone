  ...
  return (
    <div className="container">
      <div className="row">
        ...
        <div className="col-4">
          this is col-4
          <Card className="my-5 py-3 rounded">
          ...
          <div className="col-12">
            ...
            <div className="col-10">
              <button
                class="btn btn-large btn-block btn-success phone_number_btn"
                onclick="showPhoneNumber();trackContactVirtualPageView('Phone');"
                style="opacity: 1; background-color: rgb(255, 255, 255); color: rgb(21, 169, 73); border-color: rgb(21, 169, 73); background-image: none; border-width: 1px;"
                disabled="disabled"
              >
