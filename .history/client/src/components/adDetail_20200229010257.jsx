  ...
  return (
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-sm-4 ">
          <Card className="mt-4 Safety-card">
            <div className="px-5 pb-5" style={{ height: "auto" }}>
              <br />
              <h4>Price Rs.100000</h4>
              <br />
              <Button className="px-5 m-3 align-middle">03073794329</Button>
              <br />
              <Button className="px-5 m-3 align-middle">Send Message</Button>
            </div>
          </Card>
            ...
            <div className="container " style={{ height: "auto" }}>
              <div className="row">
                <div className="container py-5 ">
                  <h4 class="p-3  bg-cz text-white text-center">Seller Info</h4>
                </div>
              </div>
          ...
          {/* <Card className="mt-5">
          <div className="px-5 " style={{ height: "auto" }}>
            <br />
            <h3 className="text-center">Seller Info</h3>
            <div className="row ">
              <div className="container col-4">
                <i class="fas fa-user-circle rounded-lg border border-success"></i>
              </div>
