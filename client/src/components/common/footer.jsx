    ...
    <footer className="p-5 bg-cz text-white">
      <div className="row">
        <div className="col-4 ">
          <h3>About</h3>
          <p>
            Comfort Zone is a facilitating system, specifically
            <br /> designed for the Airport Housing Society, <br />
            Rawalpindi. Using this system. Admin can add users, <br /> get their
            accept or reject their funding compaigns etc. <br /> Similarly,
            society members can print their bills, submit <br />
            complains, use forum to discuss issues, <br />
            post an ad or a funding compain.
          </p>
        </div>
        <div className="col-4" style={{ textAlign: "left" }}>
          ...
          <p>
            <i class="fa fa-map-marker"></i> &nbsp;&nbsp;Airport Housing
            Society, Rawalpindi
          </p>
        </div>
        <div className="col-4" style={{ textAlign: "left" }}>
